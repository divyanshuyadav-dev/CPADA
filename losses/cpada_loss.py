...
def cpada_loss(preds, targets, attn_data, anchors, num_classes=1, beta1=1.0, beta2=1.0, lambda1=1.0, lambda2=1.0, t1=1.0, t2=1.0):
    """
    ...
    yolo = compute_yolo_loss(preds, targets, anchors, num_classes=num_classes)
